...
class ExchangeRateXmlParserTest {
	...
	void testParseValidXML() throws SAXException, IOException, ParserConfigurationException {
		String xmlData = "<FxRates><FxRate><Dt>2023-05-10</Dt><CcyAmt><Ccy>EUR</Ccy><Amt>1</Amt></CcyAmt><CcyAmt><Ccy>USD</Ccy><Amt>1.05</Amt></CcyAmt></FxRate></FxRates>";
		...
		assertEquals(java.sql.Date.valueOf("2023-05-10"), result.get(0).getDate());
	}
	...
	void testParseMultipleFxRates() throws SAXException, IOException, ParserConfigurationException {
		...
		assertEquals(Date.valueOf("2024-05-11"), rate1.getDate());
		...
		assertEquals(Date.valueOf("2024-05-10"), rate2.getDate());
	}
